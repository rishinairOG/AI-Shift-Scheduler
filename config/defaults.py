...
DEFAULT_OFF_DEADLINE = "FRI"
DEFAULT_PUBLISH_DAY = "SAT"
...
MANUAL_STATUS_CODES = ["PH", "HP", "S", "HD", "HO", "TR", "V"]

STATUS_LABELS = {
    "OFF": "Off Day",
    "PH": "Public Holiday",
    "HP": "Half Public Holiday",
    "S": "Sick Leave",
    "HD": "Half Day",
    "HO": "Half Off Day",
    "TR": "Transferred",
...
INTERCHANGEABLE_DESIGNATIONS = {"MANAGER", "ASST. MANAGER", "SUPERVISOR"}

KNOWN_SECTIONS = [
    "MANAGERS", "ASST. MANAGERS", "SUPERVISORS",
    "SERVERS", "GRE", "BAR", "Housekeeping",
]
